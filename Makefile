...
RAYLIB_TAG = 5.5
RAYLIB_LINUX_PREBUILT = https://github.com/raysan5/raylib/releases/download/$(RAYLIB_TAG)/raylib-$(RAYLIB_TAG)_linux_amd64.tar.gz
...
$(EXECUTABLE): $(RAYLIB_STATIC_LIB) $(SRC)
